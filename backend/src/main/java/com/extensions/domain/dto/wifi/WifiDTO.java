...
public class WifiDTO extends RepresentationModel<WifiDTO> implements Serializable {
    private String id;
    ...
    public WifiDTO(String id, String ip, String usuario, String senhaBrowser, String ssid, String senhaWifi, String idSetor, String nomeSetor) {
        this.id = id;
        this.ip = ip;
