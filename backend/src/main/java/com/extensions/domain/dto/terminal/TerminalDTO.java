...
public class TerminalDTO extends RepresentationModel<TerminalDTO> implements Serializable {
    private String id;
    ...
    public TerminalDTO(String id, String usuario, String modelo, String idSetor, String nomeSetor) {
        this.id = id;
