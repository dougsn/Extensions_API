...
public class AntenaUpdateDTO extends RepresentationModel<AntenaUpdateDTO> implements Serializable {
    ...
    public AntenaUpdateDTO() {
    }

    public AntenaUpdateDTO(String id, String ip, String localizacao, String ssid, String senha, String idLocal, String nomeLocal, String idModelo, String nomeModelo, String idTipoAntena, String nomeTipoAntena) {
        this.id = id;
        this.ip = ip;
