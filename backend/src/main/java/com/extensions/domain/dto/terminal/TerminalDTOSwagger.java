...
public class TerminalDTOSwagger implements Serializable {
    private String id;
    ...
    public TerminalDTOSwagger() {
    }

    public TerminalDTOSwagger(String id, String usuario, String modelo, String idSetor, String nomeSetor) {
        this.id = id;
