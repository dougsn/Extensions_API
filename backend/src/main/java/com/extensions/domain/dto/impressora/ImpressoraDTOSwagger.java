...
public class ImpressoraDTOSwagger implements Serializable {
    private String id;
    ...
    public ImpressoraDTOSwagger() {
    }

    public ImpressoraDTOSwagger(String id, String marca, String modelo, String ip, String tonner, String observacao, String idSetor) {
        this.id = id;
        this.marca = marca;
        this.modelo = modelo;
        this.ip = ip;
