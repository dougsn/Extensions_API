...
public class ComputadorDTO extends RepresentationModel<ComputadorDTO> implements Serializable {
    private String id;
    ...
    public ComputadorDTO(String id, String hostname, String modelo, String cpu, String memoria, String disco, String sistemaOperacional, String observacao, String idSetor, String nomeSetor) {
        this.id = id;
