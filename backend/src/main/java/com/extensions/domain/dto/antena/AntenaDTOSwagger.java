...
public class AntenaDTOSwagger implements Serializable {
    private String id;
    ...
    public AntenaDTOSwagger() {
    }

    public AntenaDTOSwagger(String id, String ip, String localizacao, String ssid, String senha, String idLocal, String nomeLocal, String idModelo, String nomeModelo, String idTipoAntena, String nomeTipoAntena) {
        this.id = id;
        this.ip = ip;
