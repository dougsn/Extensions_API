...
public class ImpressoraUpdateDTO extends RepresentationModel<ImpressoraUpdateDTO> implements Serializable {
    ...
    public ImpressoraUpdateDTO() {
    }

    public ImpressoraUpdateDTO(String id, String marca, String modelo, String ip, String tonner, String observacao, String idSetor, String nomeSetor) {
        this.id = id;
        this.marca = marca;
        this.modelo = modelo;
        this.ip = ip;
