...
public class ProjetoDTOSwagger extends RepresentationModel<ProjetoDTO> implements Serializable {
    ...
    public ProjetoDTOSwagger() {
    }

    public ProjetoDTOSwagger(String id, String nome, String descricao, String idStatus, String nomeStatus) {
        this.id = id;
        this.nome = nome;
