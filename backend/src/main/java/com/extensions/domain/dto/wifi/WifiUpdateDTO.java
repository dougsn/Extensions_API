...
public class WifiUpdateDTO extends RepresentationModel<WifiUpdateDTO> implements Serializable {
    ...
    public WifiUpdateDTO() {
    }


    public WifiUpdateDTO(String id, String ip, String usuario, String senhaBrowser, String ssid, String senhaWifi, String idSetor, String nomeSetor) {
        this.id = id;
        this.ip = ip;
