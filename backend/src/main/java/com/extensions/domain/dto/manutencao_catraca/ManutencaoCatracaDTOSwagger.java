...
public class ManutencaoCatracaDTOSwagger implements Serializable {
    private String id;
    ...
    public ManutencaoCatracaDTOSwagger() {
    }

    public ManutencaoCatracaDTOSwagger(String id, LocalDate dia, String defeito, String observacao, String idCatraca, String nomeCatraca) {
        this.id = id;
        this.dia = dia;
