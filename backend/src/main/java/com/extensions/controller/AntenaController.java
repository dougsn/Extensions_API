...
import com.extensions.domain.dto.antena.AntenaDTOExport;
...
public class AntenaController {
    ...
    @Operation(summary = "Buscando todos as antenas para exportação de dados", description = "Buscando todos as antenas para exportação de dados",
            tags = {"Antenas"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = {
                                    @Content(
                                            mediaType = "application/json",
                                            schema = @Schema(implementation = AntenaDTOExport.class)
                                    )
                            }),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
    ...
    public ResponseEntity<List<AntenaDTOExport>> findAllForExport() {
