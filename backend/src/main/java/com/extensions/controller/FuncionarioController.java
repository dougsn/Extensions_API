...
public class FuncionarioController {
    ...
    @Operation(summary = "Buscando todos os funcionarios para exportação de dados", description = "Buscando todos os funcionarios para exportação de dados",
            tags = {"Funcionario"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = {
                                    @Content(
                                            mediaType = "application/json",
                                            schema = @Schema(implementation = FuncionarioDTOExport.class)
                                    )
                            }),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
    ...
    public ResponseEntity<List<FuncionarioDTOExport>> findAllForExport() {
