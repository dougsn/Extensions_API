...
import com.extensions.domain.dto.wifi.WifiDTOExport;
...
public class WifiController {
    ...
    @Operation(summary = "Buscando todos os wifis para exportação de dados", description = "Buscando todos os wifis para exportação de dados",
            tags = {"Wi-fi"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = {
                                    @Content(
                                            mediaType = "application/json",
                                            schema = @Schema(implementation = WifiDTOExport.class)
                                    )
                            }),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
    ...
    public ResponseEntity<List<WifiDTOExport>> findAllForExport() {
