...
public class ImpressoraDTOTest implements Serializable {
    private String id;
    ...
    public ImpressoraDTOTest() {
    }

    public ImpressoraDTOTest(String id, String marca, String modelo, String ip, String tonner, String observacao, String id_setor) {
        this.id = id;
        this.marca = marca;
        this.modelo = modelo;
        this.ip = ip;
