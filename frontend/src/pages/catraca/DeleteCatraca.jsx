            ...
            {isLoading ? (
              ...
              <>
                <ModalHeader textAlign={"center"}>
                  Deletar Catraca: {catraca.nome}
                </ModalHeader>
                <ModalBody textAlign={"center"}>
                  <VStack spacing={5}>
                    <Text>Ip: {catraca.ip}</Text>
                    <Text>COM: {catraca.com}</Text>
                    <Text>MAC: {catraca.mac}</Text>
                    <Text>Número do Equipamento: {catraca.numero_do_equipamento}</Text>
                    <Text>Número de Série: {catraca.numero_de_serie}</Text>
                  </VStack>
                </ModalBody>

                <ModalFooter>
                  <DeleteButtonPopUp endpoint={"/catraca"} />
