...
export const DeleteManutencaoCatraca = () => {
    ...
    <>
      {
        <Modal
          isOpen={isOpen}
          onClose={() => navigate("/manutencao-catraca")}
          isCentered
          motionPreset="scale"
        >
          <ModalOverlay
            ...
            {isLoading ? (
              ...
              >
                ...
                <AlertTitle mt={4} mb={1} fontSize="xl">
                  Falha ao obter dados das manutenção das catracas
                </AlertTitle>
              ...
              <>
                <ModalHeader textAlign={"center"}>
                  Deletar Manutenção: {manutencaoCatraca.nome}
                </ModalHeader>
                ...
                <ModalFooter>
                  <DeleteButtonPopUp endpoint={"/manutencao-catraca"} />
